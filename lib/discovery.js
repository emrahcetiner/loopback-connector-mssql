...
function mixinDiscovery(MsSQL) {
   ...
   */
  MsSQL.prototype.queryTables = function(options) {
    var sqlTables = null;
   ...
   * @returns {string} The sql statement
   */
  MsSQL.prototype.queryViews = function(options) {
    var sqlViews = null;
    if (options.views) {
      var owner = options.owner || options.schema;
   ...
   * @returns {String} The sql statement
   */
  MsSQL.prototype.queryColumns = function(owner, table) {
    var sql = null;
    if (owner) {
    ...
    var callback = function(err, results) {
      if (err) {
        ...
        results.map(function(r) {
          r.type = self.mysqlDataTypeToJSONType(r.dataType, r.dataLength);
        });
        cb(err, results);
      }
    };
...
// http://docs.oracle.com/javase/6/docs/api/java/sql/DatabaseMetaData.html#getPrimaryKeys(java.lang.String, java.lang.String, java.lang.String)
  ...
  MsSQL.prototype.queryForPrimaryKeys = function(owner, table) {
  ...
  MsSQL.prototype.discoverPrimaryKeys = function(table, options, cb) {
    ...
    var sql = this.queryForPrimaryKeys(owner, table);
    this.execute(sql, cb);
  };
   ...
   */
  MsSQL.prototype.queryForeignKeys = function(owner, table) {
    var sql =
   ...
   * @returns {string}
   */
  MsSQL.prototype.queryExportedForeignKeys = function(owner, table) {
  ...
  MsSQL.prototype.mysqlDataTypeToJSONType = function(mysqlType, dataLength) {
